...
class DataParserTest < Minitest::Test
  attr_reader :file_path, :data, :statewide_testing_files,
  ...
  def test_loads_district_names_from_file
    districts = parser.load_districts(file_path)
  ...
  def test_parses_data
    data = parser.parse_data_from(statewide_testing_files) # NOT USING FIXTURES HERE
  ...
  def test_can_load_only_statewide_testing_files
    ...
    sw_data = parser.load_statewide_testing_data(statewide_testing_files)
  ...
  def test_can_load_only_economic_profile_files
    ...
    economic_data = parser.load_economic_profile_data(economic_testing_files)
  ...
  def test_can_load_only_enrollment_files
    ...
    enrollment_data = parser.load_enrollment_data(enrollment_testing_files)
